...
describe "CoffeeScript grammar", ->
  ...
  it "tokenizes functions", ->
    ...
    expect(tokens[2]).toEqual value: "=", scopes: ["source.coffee", "meta.function.coffee", "keyword.operator.coffee"]
    ...
    expect(tokens[6]).toEqual value: "1", scopes: ["source.coffee", "constant.numeric.coffee"]
